...
October 11 & 1.6 & Format document\\
October 14 & 1.8 & Added Fit Criteria\\
October 14 & 1.9 & Numbered FR and NFR\\
...
\begin{description}
\item [\refstepcounter{legreq} \legthelegreq:] The game must have a rating suitable for all ages\\
...
activeColor: Active region color: Orange\\
Ocolor: Player O winning color: Pink\\
Xcolor: Player X winning color: Mint\\
hoverColor: Player hover color: Grey\\
