...
Fit Criteria: 100\% of the browsers used to play the game successfully have HTML5 support 
\end{description}

\subsection{Maintainability and Support Requirements}
\begin{description}
\item [\refstepcounter{msreq} \msthemsreq:]
...
\begin{description}
\item [\refstepcounter{secreq} \sethesecreq:]
...
\begin{description}
\item [\refstepcounter{culreq} \cultheculreq:]
...
\begin{description}
\item [\refstepcounter{hsreq} \hsthehsreq:]
