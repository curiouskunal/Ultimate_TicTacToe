...
\newcommand{\uref}[1]{FR\ref{#1}}

\newcounter{lfreq}
\newcommand{\lfthelfreq}{LF\thelfreq}
\newcommand{\uref}[1]{LF\ref{#1}}

\newcounter{uhreq}
\newcommand{\uhtheuhreq}{UH\theuhreq}
\newcommand{\uref}[1]{UH\ref{#1}}

\newcounter{perreq}
\newcommand{\pertheperreq}{PR\theperreq}
\newcommand{\uref}[1]{PR\ref{#1}}

\newcounter{oereq}
\newcommand{\oetheperreq}{OE\theoereq}
\newcommand{\uref}[1]{OE\ref{#1}}
