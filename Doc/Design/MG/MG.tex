...
\begin{table}[bp]
\caption{\bf Revision History \cm{ Try adding clear page or something to make this go into correct place}}
...
hides represent likely future changes.  Design for change is valuable in SC \cm{(SC not defined)},
