...
November 11 & 0.5 & adding content \\
...
\begin{description}
\item[\refstepcounter{acnum} \actheacnum \label{acHardware}:] Currently the game is running on a local machine anticipate to move game to server.
